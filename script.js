...
const members=[
  ...
  {name:"Lee Know",kr:"리노 · Lee Min-ho",pos:"Dancer / Rapper / Vocal",unit:"Dance Racha",av:"LK",color:"#cc2222",img:"https://i.pinimg.com/736x/56/7b/4e/567b4efec58b1fec7e36551fb498bf14.jpg",birthday:"25 out 1998",height:"172 cm",mbti:"ISFP",nat:"Sul-coreano",fact:"Um dos melhores dançarinos da 4ª geração. Tem 3 gatos: Soonie, Doongie e Dori. Embaixador global da Gucci desde 2025. Lema: 'Vamos comer bem e viver bem.' Adora ler — autor favorito é Keigo Higashino."},
...
const facts=[
  ...
  {tag:"Logo",text:"O logo completo do Stray Kids foi desenhado à mão pelo próprio <strong>Bang Chan</strong> antes do debut. A cor do logo muda a cada nova era, refletindo o conceito do álbum — já foi preta, branca, vermelha e dourada. É uma das marcas registradas visuais do grupo e reforça o espírito de self-production do SKZ."},
  ...
  {tag:"Felix",text:"<strong>Felix</strong> tem uma das vozes mais reconhecíveis do K-pop — sua profundidade vocal incomum contrasta com sua aparência e virou marca registrada do grupo. Em 2025, colaborou com a cantora japonesa <strong>LiSA</strong> na música <em>'ReawakeR'</em>, tema de abertura da 2ª temporada do anime <strong>Solo Leveling</strong> — sua segunda collab com LiSA, após 'Social Path' em 2023."},
...
================================================ */
const mvs = [
  { title:"God's Menu",       year:"2020", views:"300M+ views", id:"TQTlCHxyuu8" },
  { title:"MIROH",            year:"2019", views:"200M+ views", id:"Dab4EENTW5I" },
  { title:"THUNDEROUS",       year:"2021", views:"250M+ views", id:"EaswWiwMVs8" },
  { title:"MANIAC",           year:"2022", views:"200M+ views", id:"OvioeS1ZZ7o" },
  { title:"S-CLASS",          year:"2023", views:"150M+ views", id:"JsOOis4bBFg" },
  ...
  { title:"LALALALA",         year:"2023", views:"100M+ views", id:"dBDkYofMUs4" },
];
