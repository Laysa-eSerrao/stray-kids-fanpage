...
| `script.js` | 720 | 52 KB | Dados do projeto e interatividade/renderizacao dinamica |
| `404.html` | 206 | 8 KB | Pagina de erro personalizada para GitHub Pages |
| `README.md` | 78 | 4 KB | Documentacao principal |
...
|---|---:|
| Membros | 8 |
| Albuns/singles/EPs | 29 |
| Eventos da timeline | 12 |
| Tours | 6 |
...
- Adicionar `aria-label` em botoes iconicos como busca, tema, menu, fechar modal, fechar lightbox e voltar ao topo.
- Evitar depender apenas de emojis como conteudo de botoes.
...
- Tornar os resultados da busca clicaveis para navegar ate a secao correspondente.
- Adicionar `rel="noopener noreferrer"` nos links com `target="_blank"`.
...
- Adicionar fallback visual para imagens que falharem.
...
|---|---|---|
| README menciona MelOn e Genie na grade de Stream e Votar | A implementacao renderiza Spotify, YouTube, Apple Music, MAMA, AMAs, SMA e AAA | Documentacao parcialmente desatualizada |
...
1. Atualizar README para refletir exatamente os links de stream/votacao renderizados.
...
4. Adicionar `rel="noopener noreferrer"` a links externos com `target="_blank"`.
5. Revisar dados factuais e datas futuras antes de publicar ou divulgar amplamente.

### Prioridade media

1. Separar `script.js` em blocos/arquivos logicos: dados, renderizacao, utilitarios e eventos.
2. Adicionar tratamento de erro para imagens externas.
3. Melhorar acessibilidade de modais, botoes iconicos e navegacao por teclado.
